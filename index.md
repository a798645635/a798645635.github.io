...
<body>
    ...
    <section class="project info-unit">
        ...
        <ul>
            ...
            Bruton's Tyrosine Kinase Inhibitors: Predictive Ability and Interpretability</a>（SCI，IF=3.364）。</li>
            </ul>
            <p>文章：<em>在 Molecular Diversity 上发表论文 Machine Learning Based Classification Models for Non-Covalent
            Bruton's Tyrosine Kinase Inhibitors: Predictive Ability and Interpretability（SCI，IF=3.364）
